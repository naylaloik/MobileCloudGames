...
namespace Web.Controllers
{
    public class ItensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,Nome,Idade,Descricao,Origem,TipoItemID")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,Nome,Idade,Descricao,Origem,TipoItemID")] Item item)
        {
            if (ModelState.IsValid)
            {
